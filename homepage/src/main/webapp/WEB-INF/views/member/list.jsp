...
<tr>
	...
	<td class="col-sm-8"><a href="javascript:read('${memberVO.id}')">${memberVO.id}</a></td>
</tr>
<tr>
	<th class="col-sm-2">성명</th>
	<td class="col-sm-8">${memberVO.mname}</td>
</tr>
<tr>
	<th class="col-sm-2">전화번호</th>
	<td class="col-sm-8">${memberVO.tel}</td>
</tr>
<tr>
	<th class="col-sm-2">이메일</th>
	<td class="col-sm-8">${memberVO.email}</td>
</tr>
<tr>
